...
### v3.8.2-stable (2026-01-21)
*   **Fix**: Completely rewrote card hover mechanism using Overlay + Absolute Positioning.
*   **Enhancement**: Implemented visual scale calculation to guarantee 2x magnification on any screen size.
*   **Enhancement**: Added screen boundary clamping to prevent tooltip clipping.

### v3.8.1-stable (2026-01-21)
*   Fix: Game End conditions.
*   Feature: Turn Duration & Target Score settings.
